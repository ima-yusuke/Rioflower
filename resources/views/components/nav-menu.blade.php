...
{{--    "top-0"を消して"h-full"→"h-4/5"にするとヘッダー・フッターに被らないようになる--}}
    <div class="w-full h-full m-0 p-2 flex gap-2 justify-center items-center relative">
        <button id="navToggleButton" class="absolute top-1/3 md:-right-8 md:w-8 md:h-28 -right-6 w-6 h-24 rounded-r-xl bg-top-button-pink text-white border-t border-r border-b flex items-center justify-center">
