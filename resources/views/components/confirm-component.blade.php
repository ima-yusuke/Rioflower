<div id="confirm_container" class="confirm-container hide w-full h-full flex flex-col items-center justify-center gap-4">
    ...
    {{--確認コンテナ--}}
    <div class="flex items-center rounded-3xl relative h-full w-full bg-blue-400" id="confirm">
        <div id="confirm_answers_container" class="relative flex flex-col justify-center items-center gap-6 py-4 md:py-8 w-[300px] h-[330px] md:w-[500px] md:h-[450px] bg-main-brown rounded-3xl shadow-custom-dark">
            <div class="flex flex-col items-center overflow-y-auto py-4 md:py-0 gap-6 mx-8 md:mx-8 h-full w-full" id="confirm_box"></div>
        </div>
    </div>

    {{--結果画面へ遷移ボタン--}}
    <button id="show_result_btn" class="absolute md:absolute bottom-6 md:bottom-4 md:right-8 pink-btn text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">診断結果を見る→</button>
</div>
<style>
    #confirm {
