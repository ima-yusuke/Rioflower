        ...
        <div class="qa__item bg-white border border-solid border-gray-200 w-[80%] shrink-0">
            <div class="qa__head js-ac flex items-center justify-between gap-4 py-5 px-5">
                <div class="flex flex-col">
                    <p class="flex items-center text-xl pb-2">新規カテゴリー追加</p>
                    <div class="flex justify-center items-center pt-8 pb-4">
                        <label for="category" class="pe-2 font-medium text-gray-900 text-nowrap">新規カテゴリー：</label>
                        <input type="text" name="category" id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="新規カテゴリー"/>
                    </div>
                </div>
